...
from NeuralNetworks import CartPoleNeuralNetwork
from DDQLTests import renderCartpole

env = gym.make("CartPole-v1")
cartPoleNetwork = CartPoleNeuralNetwork
...
if train == 1:
    DDQL = DoubleDeepQLearning( env, cartPoleNetwork, GAMMA, EPSILON, EPSILON_MIN, EPSILON_DEC,
                                BATCH_SIZE, TAU, LR, NUM_EPISODES, STOP, fileName)
    DDQL.train()
    renderCartpole(cartPoleNetwork, fileName + "Policy")
    ...
    renderCartpole(cartPoleNetwork, "data/cartPole/bestPolicy")